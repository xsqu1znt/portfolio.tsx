import { FloatingLabelButton } from "./FloatingLabelButton";

export function LinkedinSocialFLB() {
    return (
        <FloatingLabelButton href="https://www.linkedin.com/in/gunique-grimble" label="Linkedin">
            <svg
                fill="currentColor"
